...
/// <summary>
/// Неблокирующее окно ручного управления пускателями.
/// Открывается из StartersView кнопкой «Управление пускателями…».
/// </summary>
public partial class StartersControlWindow : Window
{
    public StartersControlWindow()
    {
        InitializeComponent();
